document.addEventListener('DOMContentLoaded', () =>{
    ...
    const currentPlayerDis = document.querySelector('#current-player');
    ...
    function checkBoard(){
        for (let i = 0; i < winningArrays.length; i++) {
            ...
            // check the squares to see if they contain the class of playerTwe
            if(
        ...
        squares[i].onclick = () => {
            ...
            if(squares[i+7].classList.contains('taken') && !squares[i].classList.contains('taken')){
                if(currentPlayer == 1){
                    ...
                    currentPlayer = 2;
                    currentPlayerDis.innerHTML = currentPlayer;
                }
                ...
                alert("This Position is not allowed")
            }
            checkBoard();
        }
    }
